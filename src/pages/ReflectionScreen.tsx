  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <motion.div
        ...
        className="flex-1 flex flex-col items-center px-6 pb-8 text-center"
      >
        ...
        <div className="text-sm text-muted-foreground leading-relaxed max-w-xs space-y-3 mb-6">
          ...
          <ul className="text-left space-y-1.5 pl-2">
            ...
            <li>• Some feel distant or unclear</li>
            <li>• There may be gaps — or just a few meaningful people</li>
          </ul>
          <p>
        ...
        <div className="w-full max-w-xs">
          ...
          <textarea
            ...
            rows={3}
            className="w-full bg-secondary rounded-2xl px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-accent/50 resize-none"
          />
        </div>
